...
- [ ] **Task 2: Cancellation Survey** (AC: 4)
...
- [ ] **Task 3: Retention Offers** (AC: 5, 6)
...
- [ ] **Task 4: Cancellation Options** (AC: 2, 7)
...
- [ ] **Task 5: Cancellation API** (AC: 2, 7)
...
- [ ] **Task 6: Cancellation Email** (AC: 8)
  - [ ] Send confirmation:
    ```typescript
...
- [ ] **Task 8: Analytics Dashboard** (AC: 10)
