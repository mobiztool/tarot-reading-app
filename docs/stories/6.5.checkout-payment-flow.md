...
- [x] **Task 1: Checkout Page** (AC: 1, 3) ✅ (Uses Stripe Hosted Checkout)
        ...
        <div className="max-w-4xl mx-auto p-8">
          ...
          <div className="bg-white rounded-lg border p-6 mb-8">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                <span>ราคา:</span>
                <span className="font-semibold">฿{tierConfig.price}/เดือน</span>
              </div>
            ...
            <div className="border-t mt-4 pt-4">
              <div className="flex justify-between text-lg font-bold">
                <span>ยอดชำระวันนี้:</span>
                <span>฿0</span>
              </div>
              <p className="text-sm text-gray-600 mt-2">
                คุณจะถูกเรียกเก็บเงิน ฿{tierConfig.price} หลังจากทดลองใช้ฟรี 7 วัน
              </p>
            </div>
          </div>
...
- [x] **Task 2: Stripe Checkout Session API** (AC: 2, 4) ✅
...
- [x] **Task 3: Checkout Button Component** (AC: 5) ✅
      ...
      return (
        <div>
          ...
          <div className="mt-4 text-center text-sm text-gray-600">
            <p>🔒 การชำระเงินปลอดภัยด้วย Stripe</p>
            <p>💳 รองรับบัตรเครดิต/เดบิตทุกธนาคาร</p>
          </div>
        </div>
      );
    }
...
- [x] **Task 4: Webhook - Handle Successful Payment** (AC: 8) ✅
...
- [x] **Task 5: Session Timeout Handling** (AC: 12) ✅
  ...
  - [ ] Show message if returning to expired session:
    ...
    if (searchParams.canceled === 'true') {
      <Alert className="mb-8">
        ...
        <AlertTitle>การชำระเงินถูกยกเลิก</AlertTitle>
        <AlertDescription>
          คุณสามารถลองใหม่ได้ทุกเมื่อที่พร้อม
        </AlertDescription>
      </Alert>
    }
    ```
...
|----|-------------|--------|
| 1 | Checkout page | ✅ (Uses Stripe Hosted Checkout) |
| 2 | Stripe Checkout integration | ✅ |
| 3 | Payment summary | ✅ (Shown on Stripe Checkout) |
| 4 | Secure card input by Stripe | ✅ |
| 5 | Loading state | ✅ |
| 6 | Success redirect to /subscription/success | ✅ |
| 7 | Cancel redirect with alert | ✅ |
| 8 | Email confirmation trigger (webhook ready) | ✅ |
| 9 | Analytics tracking | ✅ |
| 10 | Mobile-optimized (Stripe handles) | ✅ |
| 11 | Test mode works | ✅ |
| 12 | Session timeout (Stripe handles) | ✅ |

### Features Implemented

1. **Success Page** (`/subscription/success`)
   - Green checkmark animation
   - "ยินดีต้อนรับสู่ Premium!" message
   - List of benefits received
   - CTA buttons: "เริ่มดูดวงเลย" and "จัดการการสมัครสมาชิก"
...
3. **Cancel Flow**
   ...
   - Shows blue info alert: "การชำระเงินถูกยกเลิก"
...
- ✅ Success page redirects to /pricing without session_id
- ✅ Failed page shows correct error for card_declined
- ✅ Failed page shows default error for unknown codes
- ✅ Pricing page shows cancel alert when ?canceled=true
