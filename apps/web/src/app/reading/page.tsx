        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="flex justify-center gap-4 text-sm text-slate-500">
                <span className="flex items-center gap-1"><span>🃏</span> 1 ใบ</span>
                <span className="flex items-center gap-1"><span>⏱️</span> ~1 นาที</span>
              </div>
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="flex justify-center gap-4 text-sm text-slate-500">
                <span className="flex items-center gap-1"><span>🃏</span> 3 ใบ</span>
                <span className="flex items-center gap-1"><span>⏱️</span> ~3 นาที</span>
              </div>
              <div className="mt-6 text-center">
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="flex justify-center gap-4 text-sm text-slate-500">
                <span className="flex items-center gap-1"><span>🃏</span> 1 ใบ</span>
                <span className="flex items-center gap-1"><span>⏱️</span> <30 วิ</span>
              </div>
              <div className="mt-6 text-center">
